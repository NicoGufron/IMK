...
$ambil1 = $conn->query("SELECT * FROM barang join kategori on barang.id_kategori=kategori.id_kategori where barang.id_kategori = $_GET[id]"); 
$title = $ambil1->fetch_assoc();
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
   <title>MarketShop | Product</title>
   <!--meta tags -->
   <meta charset="UTF-8">
      ...
      <div class="container-fluid py-lg-5 py-md-4 py-sm-4 py-3">
         ...
         <div class="row">
            <div class="left-ads-display col-lg-12">
               <div class="row">
                  <?php
                     $q = mysqli_query($conn,"SELECT * from barang join kategori on barang.id_kategori=kategori.id_kategori where barang.id_kategori = $_GET[id]") or die (mysqli_error($conn));
												 ...
												 <div class="product-toys-info">
														<div class="men-pro-item">
															 <div class="men-thumb-item">
																	<img class="img-thumbnail" src="images/<?php echo $row['gambar']; ?>" >
																	<div class="men-cart-pro">
																		 <div class="inner-men-cart-pro">
																				<a href="single.php?id=<?= $id?>" class="link-product-add-cart">View</a>
																		 </div>
																	</div>
															 </div>
																	...
																	<div class="info-product-price">
																		 <div class="gridmeta">
																				<div class="product_price">
																					<h4>
																						<a href='single.php?id=<?= $id?>'> <b> <?= $nama ?> </b> </a>
																					</h4>
																					 <div class="grid-price mt-2">
																							<span class='money'>IDR <?= $harga ?></span>
																					 </div>
																				</div>
																		 </div>
																	</div>
