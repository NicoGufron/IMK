      ...
      <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
         ...
         <div id = "map">
            ...
            function initMap(){
               ...
               {
                  center: {lat: -7.3395864, lng: 112.7353774},
                  zoom: 18
               });
            }
            </script>
          <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAi-3A0F14tnTRGNSFzrT8z_H4czbWCy0Y&callback=initMap">
          </script>
         </div>
      </div>
   </section>
